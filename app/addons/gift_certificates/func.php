...
function fn_gift_certificate_notification(&$gift_cert_data, $force_notification = array())
{
    ...
    if ($notify_user == true && $gift_cert_data['email'] && $gift_cert_data['send_via'] == 'E') {
        ...
        if (!empty($gift_cert_data['order_ids'])) {
            $order_info = fn_get_order_info(explode(',', $gift_cert_data['order_ids'])[0]);
        ...
        $mailer->send(array(
            ...
            'data' => array(
                ...
                'certificate_status' => fn_get_status_data($gift_cert_data['status'], STATUSES_GIFT_CERTIFICATE, $gift_cert_data['gift_cert_id'], $lang_code),

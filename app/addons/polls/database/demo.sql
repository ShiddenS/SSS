...
REPLACE INTO ?:pages (page_id, parent_id, id_path, status, page_type, position, timestamp, localization, new_window, use_avail_period, avail_from_timestamp, avail_till_timestamp) VALUES ('40', '0', '40', 'A', 'P', '0', '1251115200', '', '0', 'N', '0', '0');

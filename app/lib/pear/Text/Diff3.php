...
class Text_Diff3_Op {
    ...
    {
        $this->Text_Diff3_Op($orig, $final1, $final2);
    }
...
class Text_Diff3_Op_copy extends Text_Diff3_Op {
    ...
    /**
     * Text_Diff3_Op_copy constructor.
     * @param bool|false $lines
     */
    public function __construct($lines = false)
    {
        $this->Text_Diff3_Op_Copy($lines);
    }
...
class Text_Diff3_BlockBuilder {
    ...
    /**
     * Text_Diff3_BlockBuilder constructor.
     */
    public function __construct()
    {
        $this->Text_Diff3_BlockBuilder();
    }

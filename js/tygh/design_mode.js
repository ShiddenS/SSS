...
function fn_restore_template()
{
    ...
    if (confirm(Tygh.tr('text_restore_question'))) {
        ...
        $.ceAjax('request', fn_url('design_mode.restore_template'), {method: 'post', data: {file: cur_template, current_url: Tygh.current_url}, result_ids: result_ids.join(','), caching: false});
    }
}

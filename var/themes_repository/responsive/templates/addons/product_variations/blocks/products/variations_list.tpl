...
{script src="js/addons/product_variations/variations_list_sorter.js"}
    ...
    <table class="ty-variations-list ty-table ty-table--sorter" data-ca-sortable="true">
        <thead>
            <tr>
                ...
                {/if}
                {if $show_sku}
                    <th class="ty-variations-list__title ty-left" data-ca-sortable-column="true">{__("sku")}</th>
                {/if}
                {if $show_variations}
                    {foreach $first_product.variation_features as $feature}
                        <th class="ty-variations-list__title ty-left" data-ca-sortable-column="true">{$feature.description}</th>
                    {/foreach}
                {/if}
                {if $show_product_amount}
                    <th class="ty-variations-list__title ty-right" data-ca-sortable-column="true">{__("availability")}</th>
                {/if}
                <th class="ty-variations-list__title ty-variations-list__title--right" data-ca-sortable-column="true">{__("price")}</th>

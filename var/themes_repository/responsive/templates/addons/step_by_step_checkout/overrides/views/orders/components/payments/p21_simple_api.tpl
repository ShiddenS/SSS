...
<div class="ty-control-group">
    <label for="phone_number" class="ty-control-group__title cm-required cm-mask-phone-label">{__("phone")}:</label>
    <input id="phone_number" size="35" type="text" name="payment_info[phone]" value="{$cart.payment_info.phone|default:$user_data.b_phone|default:$user_data.phone}" class="ty-input-text cm-autocomplete-off cm-mask-phone" />
</div>
<div class="ty-control-group">

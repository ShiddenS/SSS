        ...
        {strip}
            ...
            <h4>
                <span>
                    ...
                    <i id="on_{$block_content_id}" class="icon-caret-right cm-combination cm-save-state{if $smarty.cookies.$block_content_id} hidden{/if}" ></i><i id="off_{$block_content_id}" class="icon-caret-down cm-combination cm-save-state{if !$smarty.cookies.$block_content_id} hidden{/if}"></i>
                    {$block_data.name}
                </span>
            </h4>
        {/strip}

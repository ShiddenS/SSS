...
{if $block.properties.per_object}
    <fieldset>
        <textarea id="block_text_{$block.block_id}" name="block_items[block_data][block_text]" cols="65" rows="8" class="cm-wysiwyg input-textarea input-textarea-long">{$block.item_ids.block_text}</textarea>
    <fieldset>
{else}

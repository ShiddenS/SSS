{if $variation_features}{strip}
    ...
    {if $variant_names}
        ...
        {if $features_tags}<div class="product-variations__variation-features
            {if $features_secondary} product-variations__variation-features--secondary{/if}
            {if $features_inline} product-variations__variation-features--inline{/if}
            {if $features_mini} product-variations__variation-features--mini{/if}
            {if $features_clearfix} product-variations__variation-features--clearfix{/if}
        ">{/if}

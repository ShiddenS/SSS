...
<div class="control-group">
    ...
    <div class="controls">
        <input type="text" name="filename" id="filename" size="50" value="product_page_layouts_{$smarty.const.TIME|date_format:"%m%d%Y"}.xml" />
    </div>
</div>
...
<div class="buttons-container">
    {include file="buttons/save_cancel.tpl" but_text=__("export") but_name="dispatch[block_manager.export_product_layout]" cancel_action="close"}
</div>
</form>
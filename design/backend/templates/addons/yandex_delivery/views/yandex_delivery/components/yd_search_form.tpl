<div class="sidebar-row">
    ...
    <form action="{""|fn_url}" name="shipments_yandex_search_form" method="get">
        ...
        {capture name="simple_search"}
            <div class="sidebar-field">
                <label for="elm_yd_order_id">{__("yandex_delivery.order")}:</label>
                <div class="break">
            ...
            <div class="sidebar-field">
                <label for="elm_yd_status">{__("status")}:</label>
                <select name="yd_status" id="yd_status">
                    <option value="">--</option>
                    {foreach from=$shipment_yd_statuses key="status" item="name"}
                        <option value="{$status}" {if $search.yd_status == $status}selected="selected"{/if}>{$name}</option>
                    {/foreach}
                </select>
        ...
        {capture name="advanced_search"}
            ...
            {hook name="shipments:yd_search_form"}
            {/hook}
        {/capture}

        {include file="common/advanced_search.tpl" advanced_search=$smarty.capture.advanced_search simple_search=$smarty.capture.simple_search dispatch=$dispatch view_type="shipments_yandex"}
    </form>
